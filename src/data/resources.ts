...
export const resourceHubs: ResourceHub[] = [
  {
    ...
    plannedGuides: [
      { title: 'How Much Does Land Clearing Cost in Tennessee?', href: '/resources/guides/how-much-does-land-clearing-cost-in-tennessee/', description: "Why acreage alone can't price a job, and the factors that actually drive a Tennessee land-clearing estimate." },
      { title: 'What Affects Land-Clearing Cost Per Acre?', href: '/resources/guides/what-affects-land-clearing-cost-per-acre/', description: "The specific conditions that make one acre cheap and the next one expensive." },
      { title: 'Forestry Mulching Cost Versus Traditional Clearing', href: '/resources/guides/forestry-mulching-cost-versus-traditional-clearing/', description: "Where mulching's single-pass, no-haul approach saves money and where traditional clearing earns its cost." },
      { title: 'How Terrain Affects Land-Clearing Cost', href: '/resources/guides/how-terrain-affects-land-clearing-cost/', description: "Why slope, rock, and wet ground can make an easy-looking acre expensive." },
      { title: 'How Equipment Access Affects an Estimate', href: '/resources/guides/how-equipment-access-affects-an-estimate/', description: "Why the route to the work can move the price as much as the trees do." },
      { title: 'What Property Photos Should You Send for an Estimate?', href: '/resources/guides/what-property-photos-to-send-for-a-land-clearing-estimate/', description: "Exactly what to photograph so a contractor can estimate accurately from afar." },
      { title: 'Why Small Projects May Cost More Per Acre', href: '/resources/guides/why-small-projects-cost-more-per-acre/', description: "Why the per-acre rate on a small job is higher than on a big one." },
      { title: 'Does Land-Clearing Pricing Include Debris Removal?', href: '/resources/guides/does-land-clearing-pricing-include-debris-removal/', description: "Why what happens to the cleared material is one of the biggest line items — and easy to miss in a quote." },
    ],
    related: [
  ...
  },
  {
    ...
    plannedGuides: [
      { title: 'Forestry Mulching Versus Traditional Land Clearing', href: '/resources/guides/forestry-mulching-versus-traditional-land-clearing/', description: "What each method does, what it leaves behind, and which goals it fits." },
      { title: 'Brush Cutting Versus Forestry Mulching', href: '/resources/guides/brush-cutting-versus-forestry-mulching/', description: "Both knock back overgrowth — but they leave different results and fit different goals." },
      { title: 'Stump Grinding Versus Stump Removal', href: '/resources/guides/stump-grinding-versus-stump-removal/', description: "Grinding down versus pulling out — what each leaves in the ground and which your project needs." },
      { title: 'What Is Grubbing?', href: '/resources/guides/what-is-grubbing/', description: "The below-grade step that turns cleared land into buildable ground." },
      { title: 'What Is Selective Land Clearing?', href: '/resources/guides/what-is-selective-land-clearing/', description: "Clearing only what you choose while keeping the trees and features worth protecting." },
      { title: 'Can Land Be Cleared Without Removing Every Tree?', href: '/resources/guides/can-land-be-cleared-without-removing-every-tree/', description: "Opening up a property while keeping the trees worth keeping — and why that's often the smarter result." },
      { title: 'What Happens to Trees and Brush After Clearing?', href: '/resources/guides/what-happens-to-trees-and-brush-after-clearing/', description: "Where all the cleared material actually goes — and what's left on your land." },
      { title: 'When Does Cleared Material Need to Be Hauled Away?', href: '/resources/guides/when-does-cleared-material-need-to-be-hauled-away/', description: "When leaving material on-site works, and when it genuinely has to go." },
    ],
    related: [
  ...
  },
  {
    ...
    plannedGuides: [
      { title: 'How to Clear Land Covered in Dense Brush', href: '/resources/guides/how-to-clear-land-covered-in-dense-brush/', description: "What it takes to clear thick, tangled overgrowth and get usable ground back." },
      { title: 'Reclaiming Property Overgrown With Saplings', href: '/resources/guides/reclaiming-property-overgrown-with-saplings/', description: "Why young tree growth is ideal for mulching — and how to keep it from returning." },
      { title: 'How Rocky Ground Affects Land Clearing', href: '/resources/guides/how-rocky-ground-affects-land-clearing/', description: "Why surface rock on the Plateau changes methods, stump removal, and grading." },
      { title: 'Can Forestry Mulching Be Used on Steep Land?', href: '/resources/guides/can-forestry-mulching-be-used-on-steep-land/', description: "How mulching handles slopes, where the limits are, and why it often beats other methods on grade." },
      { title: 'How Wet Ground Affects Heavy Equipment', href: '/resources/guides/how-wet-ground-affects-heavy-equipment/', description: "Why saturated ground stops the work — traction, rutting, soil damage, and safety." },
      { title: 'Can Land Clearing Be Done After Heavy Rain?', href: '/resources/guides/can-land-clearing-be-done-after-heavy-rain/', description: "How long to wait after rain, and what determines when the ground is ready." },
      { title: 'Clearing Around Desirable Mature Trees', href: '/resources/guides/clearing-around-desirable-mature-trees/', description: "Protecting the trees you keep — because damage isn't only about the saw." },
      { title: 'Clearing Property With Limited Equipment Access', href: '/resources/guides/clearing-property-with-limited-equipment-access/', description: "How gates, drives, and tight lots decide what equipment can reach the work." },
    ],
    related: [
  ...
  },
  {
    ...
    plannedGuides: [
      { title: 'How to Plan a Land-Clearing Project', href: '/resources/guides/how-to-plan-a-land-clearing-project/', description: "The steps that turn a vague idea into a well-scoped, smooth project." },
      { title: 'What to Do Before Clearing Your Property', href: '/resources/guides/what-to-do-before-clearing-your-property/', description: "The readiness checklist for the days before equipment arrives." },
      { title: 'How to Mark the Area You Want Cleared', href: '/resources/guides/how-to-mark-the-area-you-want-cleared/', description: "Practical marking that prevents the most common clearing regret." },
      { title: 'Should You Get a Survey Before Land Clearing?', href: '/resources/guides/should-you-get-a-survey-before-land-clearing/', description: "When a survey is worth it before you clear — and the risk of skipping it near a boundary." },
      { title: 'How to Identify Property Lines Before Clearing', href: '/resources/guides/how-to-identify-property-lines-before-clearing/', description: "How to find your boundaries using deeds, pins, and county records — and when to call a pro." },
      { title: 'What Information Contractors Need', href: '/resources/guides/what-information-contractors-need/', description: "The exact package of details that turns a request into an accurate estimate." },
      { title: 'How Long Does Land Clearing Take?', href: '/resources/guides/how-long-does-land-clearing-take/', description: "What sets a clearing timeline — and why weather and ground conditions matter as much as acreage." },
      { title: 'What Time of Year Is Best for Land Clearing?', href: '/resources/guides/what-time-of-year-is-best-for-land-clearing/', description: "How the seasons affect ground conditions, visibility, and scheduling a clearing project." },
      { title: 'How to Prepare Gates and Entrances for Equipment', href: '/resources/guides/how-to-prepare-gates-and-entrances-for-equipment/', description: "Getting the entrance ready so the right machine can actually reach the work." },
  ...
  },
  {
    ...
    plannedGuides: [
      { title: 'Land Clearing for a New Home Site', href: '/resources/guides/land-clearing-for-a-new-home-site/', description: "How wooded ground becomes a buildable home site — clearing, grubbing, grading, and drainage." },
      { title: 'Preparing Land for a Cabin, Barn or Workshop', href: '/resources/guides/preparing-land-for-a-cabin-barn-or-workshop/', description: "Outbuilding site prep — lighter than a house, but not 'just clear a spot.'" },
      { title: 'Clearing Land for a Driveway', href: '/resources/guides/clearing-land-for-a-driveway/', description: "What it takes to put a durable driveway through wooded or rural ground." },
      { title: 'Clearing Versus Grading', href: '/resources/guides/clearing-versus-grading/', description: "Removing vegetation versus shaping the ground — two different jobs, usually both needed." },
      { title: 'Why Stumps and Roots Must Be Removed From Building Areas', href: '/resources/guides/why-stumps-and-roots-must-be-removed-from-building-areas/', description: "The decay-and-settling problem that makes grubbing non-negotiable under structures." },
      { title: 'What Is a Building Pad?', href: '/resources/guides/what-is-a-building-pad/', description: "The prepared, compacted base a structure sits on — and what makes a good one." },
      { title: 'How Drainage Should Be Considered Before Grading', href: '/resources/guides/how-drainage-should-be-considered-before-grading/', description: "Grading decides where water goes — so plan the water before you shape the ground." },
      { title: 'Preparing Rural Land for Septic Installation', href: '/resources/guides/preparing-rural-land-for-septic-installation/', description: "How clearing and access work support a septic system installation on rural ground." },
      { title: 'What Should Happen After a Lot Is Cleared?', href: '/resources/guides/what-should-happen-after-a-lot-is-cleared/', description: "Why a cleared lot isn't a finished lot — and what comes next." },
      { title: 'When Does a Site Need Erosion Control?', href: '/resources/guides/when-does-a-site-need-erosion-control/', description: "When disturbed ground needs protecting from washing away — and how it's done." },
    ],
    related: [
  ...
  },
  {
    ...
    plannedGuides: [
      { title: 'How to Reclaim an Overgrown Pasture', href: '/resources/guides/how-to-reclaim-an-overgrown-pasture/', description: "Turning brush- and cedar-choked fields back into usable grazing and hay ground." },
      { title: 'How to Clear a Fence Line', href: '/resources/guides/how-to-clear-a-fence-line/', description: "Opening up brush-choked boundaries and farm fencing — and keeping them clear." },
      { title: 'How Wide Should a Cleared Fence Line Be?', href: '/resources/guides/how-wide-should-a-cleared-fence-line-be/', description: "Picking a fence-line width that protects the fence and stays easy to maintain." },
      { title: 'Creating Access Trails Through Wooded Property', href: '/resources/guides/creating-access-trails-through-wooded-property/', description: "Turning unreachable back acreage into land you can actually get to and use." },
      { title: 'Clearing Trails for Hunting and Recreation', href: '/resources/guides/clearing-trails-for-hunting-and-recreation/', description: "Trails, shooting lanes, and food-plot access that make hunting land more productive." },
      { title: 'Clearing Around a Farm Pond', href: '/resources/guides/clearing-around-a-farm-pond/', description: "Opening up an overgrown pond while protecting the banks and water." },
      { title: 'Preparing a Site for a New Pond', href: '/resources/guides/preparing-a-site-for-a-new-pond/', description: "What it takes to go from wooded ground to a site ready for pond excavation." },
      { title: 'Improving Access to Rural Acreage', href: '/resources/guides/improving-access-to-rural-acreage/', description: "Why access is the quiet key to rural land — and how clearing unlocks it." },
      { title: 'Maintaining Land After Forestry Mulching', href: '/resources/guides/maintaining-land-after-forestry-mulching/', description: "Keeping mulched ground open — because clearing once isn't clearing forever." },
      { title: 'Reopening an Abandoned Farm Road', href: '/resources/guides/reopening-an-abandoned-farm-road/', description: "Reclaiming a grown-over roadbed instead of building a new one." },
    ],
    related: [
  ...
  },
  {
    ...
    plannedGuides: [
      { title: 'Land Clearing in the Upper Cumberland: Property Owner’s Guide', href: '/resources/guides/land-clearing-in-the-upper-cumberland-property-owners-guide/', description: "How the region's rock, terrain, vegetation, and seasons shape land-clearing projects." },
      { title: 'Common Land-Clearing Conditions Around Cookeville', href: '/resources/guides/common-land-clearing-conditions-around-cookeville/', description: "The property mix, terrain, and vegetation that shape clearing projects in Putnam County." },
      { title: 'Land-Clearing Considerations on the Cumberland Plateau', href: '/resources/guides/land-clearing-considerations-on-the-cumberland-plateau/', description: "How the Plateau's sandstone and thin soils shape clearing around Crossville and beyond." },
      { title: 'Clearing Sloped Tennessee Property', href: '/resources/guides/clearing-sloped-tennessee-property/', description: "Working the region's hillsides and hollows safely — and keeping the soil in place." },
      { title: 'Cedar and Brush Encroachment on Pastureland', href: '/resources/guides/cedar-and-brush-encroachment-on-pastureland/', description: "Why cedar takes over Tennessee pasture — and how to reverse and prevent it." },
      { title: 'Rocky Ground and Land Preparation', href: '/resources/guides/rocky-ground-and-land-preparation/', description: "A regional look at how rock shapes site prep — building, grading, ponds, and stumps." },
      { title: 'Seasonal Ground Conditions for Land Clearing', href: '/resources/guides/seasonal-ground-conditions-for-land-clearing/', description: "How the region's seasons open and close the windows for working the ground." },
      { title: 'Rural Equipment Access in the Upper Cumberland', href: '/resources/guides/rural-equipment-access-in-the-upper-cumberland/', description: "The regional access realities — drives, gates, ridges, and hollows — that decide what equipment reaches the work." },
      { title: 'Questions to Ask Before Buying Overgrown Land', href: '/resources/guides/questions-to-ask-before-buying-overgrown-land/', description: "What to check about access, terrain, boundaries, and clearing before you buy overgrown acreage." },
      { title: 'Estimating the Usable Acreage of an Overgrown Parcel', href: '/resources/guides/estimating-the-usable-acreage-of-an-overgrown-parcel/', description: "Why total acreage and usable acreage differ — and how to gauge what you can really use." },
    ],
    related: [
